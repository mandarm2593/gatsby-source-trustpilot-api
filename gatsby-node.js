    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    publicBusinessUnitInfo = _a.sent();
                    nodeContent = JSON.stringify(publicBusinessUnitInfo);
                    nodeMeta = {
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    BusinessUnitReviews = _a.sent();
                    nodeContent = JSON.stringify(BusinessUnitReviews);
                    nodeMeta = {
                        id: createNodeId("trustpilot-public-business-unit-" + configOptions.domainName),
                        parent: null,
                        children: [],
